...
const OrderForm = () => {
    ...
    useEffect(() => {
        if (customers.currentCustomer.id > 0) {
            setOrder({
                ...order,
                customerId: customers.currentCustomer.id,
                customerName: customers.currentCustomer.name,
                phoneNumber: customers.currentCustomer.phoneNumber,
                email: customers.currentCustomer.email
            });
        }
